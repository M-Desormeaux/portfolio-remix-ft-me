const iconSize = 30;
const iconColor = "fill-indigo-900";

export const Skillset = () => {
  return (
    <div className="flex flex-col items-center gap-4 bg-slate-200 p-5">
      <h2 className="text-3xl font-bold md:text-4xl">Skills</h2>
      <div className="flex flex-wrap items-center justify-center gap-3">
        {/* HTML */}
        <div className="flex w-14 flex-col items-center gap-1">
          <svg
            className="dropshadow-md rounded-md  p-1"
            viewBox="0 0 128 128"
            height={iconSize}
            width={iconSize}
          >
        ...
        <div className="flex w-14 flex-col items-center gap-1">
          <svg
            className="dropshadow-lg rounded-md  p-1"
            viewBox="0 0 128 128"
            height={iconSize}
            width={iconSize}
          >
        ...
        <div className="flex w-14 flex-col items-center gap-1">
          <svg
            ...
            width={iconSize}
          >
            <title>Typescript language</title>
            <path fill="transparent" d="M22.67 47h99.67v73.67H22.67z"></path>
            <path
              data-name="original"
              className={iconColor}
        ...
        <div className="flex w-14 flex-col items-center gap-1">
          <svg
            ...
            width={iconSize}
          >
            <title>Jest testing tools</title>
            <path
              className={iconColor}
        ...
        <div className="flex w-14 flex-col items-center gap-1">
          <svg
            ...
            width={iconSize}
          >
            <title>Bash scripting language</title>
