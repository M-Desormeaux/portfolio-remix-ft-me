...
export default function Index() {
  return (
    <>
      <div className="p-2 flex flex-col gap-3 h-[80vh] justify-center items-center">
        {/* <q>Howdy there, my name is</q> */}
        <h1 className="text-5xl font-bold text-center sm:text-6xl drop-shadow">
          Michael Desormeaux
        </h1>
        <p className="text-xl sm:text-2xl text-center max-w-md text-slate-800">
        ...
        <div className="flex justify-center items-center gap-2">
          <svg viewBox="0 0 128 128" height={iconSize} width={iconSize}>
            <path fill="#eee" d="M22.67 47h99.67v73.67H22.67z"></path>
            <path
              data-name="original"
              fill="#007acc"
